...
{
	AddDamageType("Shovel", '<bitmap:Add-Ons/GameMode_JJstormsCityRPG/shapes/ci/shovel> %1', '%2 <bitmap:Add-Ons/GameMode_JJstormsCityRPG/shapes/ci/shovel> %1', 0.5, 1);
	...
	datablock ItemData(CityRPGShovelItem)
	{
		...
		shapeFile		= "Add-Ons/GameMode_JJstormsCityRPG/shapes/shovel.2.dts";
		mass			= 1;
		density 		= 0.2;
		elasticity		= 0.2;
		friction		= 0.6;
		...
		uiName			= "Shovel";
		iconName		= "Add-Ons/GameMode_JJstormsCityRPG/shapes/ItemIcons/shovel";
		doColorShift	= true;
